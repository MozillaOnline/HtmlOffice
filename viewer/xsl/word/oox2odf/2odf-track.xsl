...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:oox="urn:oox"
  exclude-result-prefixes="w r rels wp oox">
            ...
            <text:changed-region>
              ...
              <text:deletion>
                <office:change-info>
                  ...
                  <dc:date>
                    <xsl:value-of select="concat('ooc-FormatDateTime', '-oop-', parent::w:del/@w:date, '-ooe')" />
                  </dc:date>
                </office:change-info>
                <text:p>
        ...
        <text:changed-region>
          ...
          <text:insertion>
            <office:change-info>
              ...
              <dc:date>
                <xsl:value-of select="concat('ooc-FormatDateTime', '-oop-', parent::w:ins/@w:date, '-ooe')" />
              </dc:date>
            </office:change-info>
          </text:insertion>
        </text:changed-region>
        ...
        <text:changed-region>
          ...
          <text:format-change>
            <office:change-info>
              ...
              <dc:date>
                <xsl:value-of select="concat('ooc-FormatDateTime', '-oop-', descendant::w:rPrChange/@w:date, '-ooe')" />
              </dc:date>
            </office:change-info>
          </text:format-change>
        </text:changed-region>
        ...
        <text:changed-region text:id="{generate-id(.)}">
          <text:deletion>
            <office:change-info>
              ...
              <dc:date>
                <xsl:value-of select="concat('ooc-FormatDateTime', '-oop-', w:del/@w:date, '-ooe')" />
              </dc:date>
            </office:change-info>
              ...
              <xsl:attribute name="text:style-name">
                <xsl:choose>
                  <xsl:when test="key('p', @oox:id+1)/w:pPr/w:pPrChange/w:pPr/w:pStyle">
                    <xsl:value-of select="concat('ooc-NCNameFromString', '-oop-', key('p', @oox:id+1)/w:pPr/w:pPrChange/w:pPr/w:pStyle/@w:val, '-ooe')" />
                  </xsl:when>
                  <xsl:otherwise>
        ...
        <text:changed-region text:id="{generate-id(ancestor::w:p)}">
          <text:insertion>
            <office:change-info>
              ...
              <dc:date>
                <xsl:value-of select="concat('ooc-FormatDateTime', '-oop-', w:ins/@w:date, '-ooe')" />
              </dc:date>
            </office:change-info>
          </text:insertion>
        </text:changed-region>
